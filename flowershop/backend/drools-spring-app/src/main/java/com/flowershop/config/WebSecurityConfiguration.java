...
import com.flowershop.util.RestAuthenticationEntryPoint;
import com.flowershop.util.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public PasswordEncoder passwordEncoder() {
        ...
        // return PasswordEncoderFactories.createDelegatingPasswordEncoder(); // with
        // new spring security 5
    }

    // Servis koji se koristi za citanje podataka o korisnicima aplikacije
    @Autowired
    private KupacService jwtUserDetailsService;
